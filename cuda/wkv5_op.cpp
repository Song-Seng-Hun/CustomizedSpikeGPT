...
{
    cuda_backward(B, T, C, H, r.data_ptr<f16>(), k.data_ptr<f16>(), v.data_ptr<f16>(), w.data_ptr<float>(), ww.data_ptr<float>(), u.data_ptr<f16>(), gy.data_ptr<f16>(), gr.data_ptr<f16>(), gk.data_ptr<f16>(), gv.data_ptr<f16>(), gw.data_ptr<f16>(), gu.data_ptr<f16>());
}
