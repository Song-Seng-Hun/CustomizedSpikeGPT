...
wkv5_cuda = load(name="wkv", sources=["cuda/wkv_op.cpp", f"cuda/wkv_cuda.cu"],
                verbose=True, extra_cuda_cflags=["-allow-unsupported-compiler", "-res-usage", "--use_fast_math", "-O3", "-Xptxas=-O3", "--extra-device-vectorization", f"-D_N_={HEAD_SIZE}"])
